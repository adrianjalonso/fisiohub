        ...
        <section className="flex flex-col justify-center items-center h-screen w-full lg:w-3/5 bg-primary-light" >
          <div className="w-full max-w-[480px] flex flex-col gap-8">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-base text-primary">Junte-se á maior plataforma de gestão clinica para fisoterapeutas de Brasil.</p>
            </div>
            <form className="flex flex-col gap-5 w-full">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-sm font-medium ">Registro Profissional (CREFITO)</label>
                <div className="relative">
                  <span className="absolute flex items-center pl-3 pointer-events-none inset-x-0 inset-y-0">
              ...
              <div className="flex items-start gap-3 py-2">
                <div className="flex items-center h-3">
                  <input className="size-5 rounded text-primary focus:ring-primary/20 cursor-pointer" type="checkbox" />
                </div>
                <label className="cursor-pointer text-sm">
                  Eu concordo com os <a className="text-primary font-bold hover:underline">Termos de Uso</a> e a <a className="text-primary font-bold hover:underline">Politica de Privacidade</a> do FisioHub.
                </label>
              </div>
              <Link to="/dashboard"  className="mt-2 w-full bg-primary shadow-md font-semibold h-12 rounded-lg  flex items-center justify-center text-white" >
                Criar minha conta <span className="material-symbols-outlined mx-2">arrow_right_alt</span>
                </Link>
            </form>
